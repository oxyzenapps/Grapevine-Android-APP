package com.grapevine.ftpclient;
...
public class FTPClient
       // extends AsyncTask<Void, Void, FTPClient>
{
     ...
     * @throws ConnectException
     */
    public void dir(final ca.team2706.scouting.ftptest.FTPRequester requester) throws ConnectException{
        synchronized (connectedThreadLock) {
            if (!connected) {
     ...
     * @throws ConnectException
     */
    public void downloadFile(final String filename, final ca.team2706.scouting.ftptest.FTPRequester requester)throws ConnectException {
        synchronized (connectedThreadLock){
            if(!connected){
     ...
     * @throws ConnectException
     */
    public void uploadFile(final String filename, final ca.team2706.scouting.ftptest.FTPRequester requester)throws ConnectException {
        synchronized (connectedThreadLock){
            if(!connected){
    ...
    public void syncAllFiles(final ca.team2706.scouting.ftptest.FTPRequester requester, final Activity activity)throws ConnectException{
      synchronized (connectedThreadLock){
            if(!connected){
