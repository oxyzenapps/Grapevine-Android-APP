        ...
        return Thread(Runnable {
            ...
            mCursor = if (showGif) {
                resolver.query(mImageUri, null,
                        ...
                        arrayOf("image/jpeg", "image/png", "image/x-ms-bmp", "image/gif","video/*"), MediaStore.Images.Media.DATE_MODIFIED + " desc")
            } else {
                resolver.query(mImageUri, null,
                        MediaStore.Images.Media.MIME_TYPE + "=? or "
                                + MediaStore.Images.Media.MIME_TYPE + "=? or "
                                + MediaStore.Images.Media.MIME_TYPE + "=? or "
                                + MediaStore.Video.Media.MIME_TYPE + "=?",
                        arrayOf("image/jpeg", "image/png", "image/x-ms-bmp","video/*"), MediaStore.Images.Media.DATE_MODIFIED + " desc")
            }
