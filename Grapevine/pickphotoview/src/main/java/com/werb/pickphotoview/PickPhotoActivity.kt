...
class PickPhotoActivity :  BasePickActivity() {
    ...
    private fun initToolbar() {
        ...
        GlobalData.model?.let {
            ...
            midTitle.solidColor(color(it.toolbarTextColor))
            cancel.solidColor(color(it.toolbarTextColor))
            sure.solidColor(alphaColor(color(it.toolbarTextColor)))
            midTitle.tooltipText= string(R.string.pick_all_photo)
            sure.tooltipText = String.format(string(R.string.pick_photo_sure), selectImages.size)
...
private operator fun Int.invoke(color: Int) {
