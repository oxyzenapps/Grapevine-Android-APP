...
public class DNAGalleryPickerActivity extends RequestPermissionActivity {
   ...
   // private ViewPager vpMediaPicker;
    ...
    public static boolean includePhoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        includePhoto=getIntent().getBooleanExtra("includePhoto",true);
        includeVideo=getIntent().getBooleanExtra("includeVideo",true);
        includeAudio=getIntent().getBooleanExtra("includeAudio",true);
        ...
        String[] permissions = new String[]{Manifest.permission.READ_MEDIA_AUDIO,Manifest.permission.READ_MEDIA_VIDEO,Manifest.permission.READ_MEDIA_IMAGES};
...
// remove selected media list
    ...
    private void checkCameraPermission(final int type) {
        ...
        String[] permissions = new String[]{Manifest.permission.CAMERA, Manifest.permission.READ_MEDIA_IMAGES, Manifest.permission.READ_MEDIA_VIDEO};
        if (!hasPermissions(this, permissions)) {
            checkRunTimePermissions(permissions);
        } else {
    ...
    private void OpenCameraForImage() {
        ...
        if (photoFile != null) {
            ...
            Uri photoURI = FileProvider.getUriForFile(DNAGalleryPickerActivity.this, this.getApplicationContext().getPackageName() + ".provider", photoFile);
...
// for full mode
        ...
        if (mode == AppConstants.OPEN_GALLERY_AUDIOS || mode == AppConstants.OPEN_GALLERY_IMAGES_VIDEOS) {
            adapter.addFragment(new AudioFragment(), getString(R.string.audio));
            viewImageCamera.setVisibility(View.GONE);
            viewRecordingCamera.setVisibility(View.GONE);
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Toast.makeText(getApplicationContext(),"Request Code:"+requestCode,Toast.LENGTH_LONG);
