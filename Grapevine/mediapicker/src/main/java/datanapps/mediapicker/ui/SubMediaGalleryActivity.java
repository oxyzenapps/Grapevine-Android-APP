...
public class SubMediaGalleryActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (parent.equals("Images")) {
            ...
            mediaNameList.addAll(AudioFragment.AudiosNameList);
            mediaList.addAll(AudioFragment.AudiosList);
            selected.addAll(AudioFragment.selected);
        }
    ...
    private void populateRecyclerView() {
        ...
        mAdapter = new GalleryMediaAdapter(mediaList,mediaNameList, selected,parent, getApplicationContext());
