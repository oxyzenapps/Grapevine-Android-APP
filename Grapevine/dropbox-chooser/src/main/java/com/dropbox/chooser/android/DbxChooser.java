...
public class DbxChooser {
    ...
    public enum ResultType {
        ...
        //FILE_CONTENT("Intent.ACTION_GET_CONTENT");
    ...
    private static boolean isChooserAvailable(PackageManager pm) {
        ResultType[] resultTypes = {
                ...
                ResultType.PREVIEW_LINK,
                ResultType.DIRECT_LINK };
...
//            @Override
//            public androidx.fragment.app.FragmentManager getSupportFragmentManager() {
//                FragmentActivity act = (FragmentActivity) mFrag.getActivity();
//                if (act == null) {
//                    return null;
//                }
