...
public class AuthorizationRequest implements Parcelable {
    ...
    private String[] mScopes ={"user-read-playback-state","user-modify-playback-state","user-read-currently-playing",
                "user-read-private","playlist-modify-public","playlist-read-private","playlist-modify-private",
            "playlist-read-collaborative","user-read-playback-state","user-library-modify","user-library-read",
            "user-top-read","user-read-recently-played","user-read-playback-position","user-follow-read","user-follow-modify"};
