...
public class GetDataFromNetworkSync extends AsyncTask<Void, String, Object> {
    private String URL;
    ...
    public GetDataFromNetworkSync(Context context, int progressBarStyle, String message, GetDataCallBack callBack) {
