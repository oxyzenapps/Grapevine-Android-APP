...
public class PhoneCallListener extends PhoneStateListener {
    ...
    public PhoneCallListener(TextView textView,Context mContext) {
        mTextView = textView;
        context=mContext;
    }
    ...
    public void PhoneCallback(TextView textView) {
        mTextView = textView;
    }
        ...
        appPreferences = new AppPreferences(context);
         ...
         if(state==1){
             HomeActivity mHomeActivity=new HomeActivity();
                 ...
                 String  MyMobile="7045373464";
                 //incomingNumber="8800366499";
                 //MyMobile=mHomeActivity.GetUserMobile().replace("+91","");
             MyMobile=appPreferences.getLoginUserMobileNo();
             if(MyMobile==null || MyMobile.equals("")){
                 JSONObject obj=mHomeActivity.GetloginDetailsOverContactID(appPreferences.getApplicant_id());
                 try {
                     if(obj!=null){
             ...
             String LeadThreadID=mHomeActivity.crm_feed_Get_leadthread_from_mobile(MyMobile,incomingNumber.replace("+91",""));
//             mHomeActivity.addToGroup(Long.parseLong(String.valueOf(contactID)), GroupID);
             String AssociateID=appPreferences.getApplicant_id();
          String ActivityThreadID=   mHomeActivity.Crm_Add_Activity(LeadThreadID, "", "AST-1","CHN-1",
                     "Incoming Call","","", AssociateID, "", "",
                     "","","");
             mHomeActivity.Crm_Add_Activity(LeadThreadID, ActivityThreadID, "","CHN-1",
                     "Incoming Call","","", AssociateID, "", "",
                     "","","");
         }
        Log.i(LOG_TAG, message);
